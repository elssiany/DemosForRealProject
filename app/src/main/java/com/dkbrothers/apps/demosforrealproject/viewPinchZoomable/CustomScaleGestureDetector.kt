...
import com.dkbrothers.apps.demosforrealproject.viewPinchZoomable.CustomScaleGestureDetector.OnScaleGestureListener
...
internal class CustomScaleGestureDetector(private val mListener: OnScaleGestureListener) {
    ...
    internal interface OnScaleGestureListener {
         ...
         * pointers going up.
         *
         * Once a scale has ended, [CustomScaleGestureDetector.getFocusX]
         * and [CustomScaleGestureDetector.getFocusY] will return the location
